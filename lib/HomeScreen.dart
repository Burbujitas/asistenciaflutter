...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final RendicionModel proData = ModalRoute.of(context).settings.arguments;

    print('holasa');
    print(proData.numeroreq);
              ...
              child: Column(
                ...
                children: <Widget>[
                  Row(
                    ...
                    children: <Widget>[
                      Text("\$ ${proData.gasto_actual}", style: TextStyle(color: Colors.white, fontSize: 36, fontWeight: FontWeight.w700),),
...
Widget _crearList(RendicionModel reque){
 return FutureBuilder(
   future: rendicionesProvider.cargarrequerimientos(reque.numeroreq),

   builder: (BuildContext context, AsyncSnapshot<List<RequerimientoModel>> snapshot) {
     if(snapshot.hasData ){
  ...
  Widget _crearvista(RequerimientoModel rendi){
  String hola= DateFormat('yyyy-MM-dd').format(rendi.fecha);
                          return Column(
                              ...
                              child: Row(
                                children: <Widget>[
                                  Container(
                                    ...
                                    child: Icon(Icons.payment, color: Colors.lightBlue[900],),
                                    padding: EdgeInsets.all(12),
                                  ),
                                  ...
                                  Expanded(
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: <Widget>[
                                        Text(rendi.razon, style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: Colors.grey[900]),),
                                        Text(hola, style: TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: Colors.grey[500]),),
                                      ],
                                    ),
                                  ),
                                  ...
                                  Column(
                                    crossAxisAlignment: CrossAxisAlignment.end,
                                    children: <Widget>[
                                      Text("+\$ ${rendi.monto}", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: Colors.lightGreen),),
                                      Text(rendi.tipoGasto, style: TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: Colors.grey[500]),),
                                    ],
                                  ),
                                ],
                              ),
